...
- Typos and repeated words (e.g. "with with", "the the")
- Leftover words that make no grammatical sense in context
- Missing articles or words where the omission is clearly accidental
- Em dashes (—) — replace with a spaced hyphen ( - )
